...
import pigpio.javadsl.{rawCbs_t, rawWave_t, _}
...
object PigpioLibrary {
  ...
  trait gpioAlertFunc_t extends Callback {def callback(gpio: Int, level: Int, tick: Int)}
  trait gpioAlertFuncEx_t extends Callback {def callback(gpio: Int, level: Int, tick: Int, userdata: Pointer)}
  trait gpioISRFunc_t extends Callback {def callback(gpio: Int, level: Int, tick: Int)}
  trait gpioISRFuncEx_t extends Callback {def callback(gpio: Int, level: Int, tick: Int, userdata: Pointer)}
  trait gpioTimerFunc_t extends Callback {def callback()}
  trait gpioTimerFuncEx_t extends Callback {def callback(userdata: Pointer)}
  trait gpioSignalFunc_t extends Callback {def callback(signum: Int)}
  trait gpioSignalFuncEx_t extends Callback {def callback(signum: Int, userdata: Pointer)}
  trait gpioGetSamplesFunc_t extends Callback {def callback(samples: gpioSample_t, numSamples: Int)}
  trait gpioGetSamplesFuncEx_t extends Callback {def callback(samples: gpioSample_t, numSamples: Int, userdata: Pointer)}
